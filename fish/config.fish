...
# pacman and paru
alias spsyu='sudo pacman -Syu'                   # update only standard pkgs
alias spsyyu='sudo pacman -Syyu'                 # Refresh pkglist & update standard pkgs
alias update='sudo pacman -Syyu'                 # Refresh pkglist & update standard pkgs
alias psua='paru -Sua --noconfirm'               # update only AUR pkgs (paru)
alias psyu='paru -Syu --noconfirm'               # update standard pkgs and AUR pkgs (paru)
